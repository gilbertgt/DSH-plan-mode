...
import {extractPlanArtifact,validatePlanArtifact,normalizeOwnedPath,schedulerPathIdentity,parseValidationCommand} from '../../src/contract/plan-artifact.ts'
const plan={planModeVersion:1,summary:'x',complexity:'small',decisionLocks:[],tasks:[{id:'t1',title:'t',objective:'o',read:['src/a.ts'],modify:['src/a.ts'],decisionLocks:[],requiredChanges:['x'],acceptanceCriteria:['passes'],validation:['npm test'],dependsOn:[],parallelSafe:false}],validationStrategy:[],validationCommands:[{id:'unit',taskIds:['t1'],command:'npm test',timeoutMs:1000}],risks:[],outOfScope:[]}
